...
const Project = () => {
    return(
        <div id="Projects">
            ...
            <h2>FoodPicker</h2>
            <h4><em>Implemented with : JavaScript, NodeJS · Sep 2019</em></h4>
            ...
            <h2>TopMovies</h2>
            <h4><em>Implemented with : Java, AWS, MySQL  ·  March 2020</em></h4>
            <ul>
            ...
            <h2>ZotBoba</h2>
            <h4><em>Implemented with : NodeJS    July 2019</em></h4>
            <ul>
            ...
            <h2>W-Warriors</h2>
            <h4><em>Implemented with : Unity, C#  ·  Jan. 2018 </em></h4>
            <ul>
